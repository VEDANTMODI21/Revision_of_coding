...
| **Link** | [View Problem](https://leetcode.com/problems/separate-the-digits-in-an-array/) |
| **Runtime** | 8 ms |
| **Memory** | 16.1 MB |
...
<pre style="display: block;"><strong>Input:</strong> nums = [13,25,83,77]
...
<pre style="display: block;"><strong>Input:</strong> nums = [7,1,3,9]
...
**Author**: [@Bhushan_Mahajan](https://leetcode.com/Bhushan_Mahajan/)
**Upvotes**: 31 👍
**Link**: [View Original Post](https://leetcode.com/problems/separate-the-digits-in-an-array/solutions/3141479/)
