...
| **Link** | [View Problem](https://leetcode.com/problems/sum-of-primes-between-number-and-its-reverse/) |
| **Runtime** | 3 ms |
| **Memory** | 8.5 MB |

## Approach

revise this qs, multiple edge cases here
...
<p>Return the <strong>sum</strong> of all <span data-keyword="prime-number" class=" cursor-pointer relative text-dark-blue-s text-sm"><button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-_r_9h_" data-state="closed" class="">prime numbers</button></span> between <code>min(n, r)</code> and <code>max(n, r)</code>, inclusive.</p>
