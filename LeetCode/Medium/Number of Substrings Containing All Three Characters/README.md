...
<pre style="display: block;"><strong>Input:</strong> s = "abcabc"
...
<pre style="display: block;"><strong>Input:</strong> s = "aaacb"
...
<pre style="display: block;"><strong>Input:</strong> s = "abc"
